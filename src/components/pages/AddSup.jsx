                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="form-group has-feedback">
                      ...
                      <input className="form-control" placeholder="First Name" type="text" required />
                  ...
                  <div className="col-md-6">
                    <div className="form-group has-feedback">
                      ...
                      <input className="form-control" placeholder="Last Name" type="text" required />
                      <span className="fa fa-user form-control-feedback" aria-hidden="true" />
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="form-group has-feedback">
                      ...
                      <input className="form-control" placeholder="E-mail" type="email" required />
                  ...
                  <div className="col-md-6">
                    <div className="form-group has-feedback">
                      ...
                      <textarea className="form-control" id="placeTextarea" rows={3} placeholder="Address..." required defaultValue={""} />
                    </div>
                  </div>
